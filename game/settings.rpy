...
define discord.application_id = "1245725921567182939"

#####################################################################################################################################

# State of the Presence upon the game's launch and return to the main menu..
define discord.main_menu_state = { "details" : "Working on Rizztaurant!",
                                   "large_image" : "restaurant"}

# State of the Presence when the game is started.
define discord.start_state = { "details" : "Working hard.",
                               "large_image" : "restaurant"}
